    ...
    <div className='box'>
      ...
      <div className="divmain">
        ...
        <div className="divr">
          ...
          <form action='https://formspree.io/f/xrgvpjno' method='POST'>  
            <div className="mb-3">
            ...
            <div className="mb-3">
              <label for="exampleInputNumber" className="form-label">Your Phone Number</label>
              <input type="text" name="number" className="form-control" id="exampleInputNumber" />
            </div>
            <div class="form-group">
              <label for="exampleFormControlTextarea1">Your Message</label>
              <textarea name="message" className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
            </div>
            <button type="submit" id='submit' value="send" className="btn btn-primary"><GrSend />&emsp;Send</button>
          </form>
        </div>
      </div>
    </div>
